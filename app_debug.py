...
@app.route('/test-no-deps')
def test_no_deps():
    """Test page without external dependencies"""
    return '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>No Dependencies Test</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <div class="card">
            ...
            <p>No Bootstrap, no Google Fonts, no external JS</p>
            <p>Check memory usage - should be ~10-30MB</p>
            <p><a href="/">← Back to Home</a></p>
        </div>
    </div>
    <script>
        console.log('Zero dependencies page loaded');
        if (performance.memory) {
            const used = Math.round(performance.memory.usedJSHeapSize / 1024 / 1024);
            console.log('JS Heap used:', used + 'MB');
        }
    </script>
</body>
</html>
